...
Especificações relacionadas: [`../specs/`](../specs/) — em especial [`agent-ia-governance.md`](../specs/agent-ia-governance.md) (governança e checklists para agentes de IA), [`agent-session-workflow.md`](../specs/agent-session-workflow.md) (fluxo por prompt), [`agent-reference-clippings.md`](../specs/agent-reference-clippings.md) (`reference/Clippings/`) e [`agent-documentation-workflow.md`](../specs/agent-documentation-workflow.md). Instruções para agentes: [`../AGENTS.md`](../AGENTS.md).
