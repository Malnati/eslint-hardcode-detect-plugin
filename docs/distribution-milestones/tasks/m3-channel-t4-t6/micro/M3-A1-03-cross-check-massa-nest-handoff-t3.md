...
- Bullets operacionais do pipeline (instalação, `lint`, testes do workspace do plugin): secção «O que o T3 (CI) já valida (handoff)» em [`M3-A1-02-passos-eslint-config-workspace-settings.md`](M3-A1-02-passos-eslint-config-workspace-settings.md) — evita duplicar parágrafos longos aqui.
