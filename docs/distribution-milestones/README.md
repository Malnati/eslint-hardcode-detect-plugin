...
**Ficheiros de tarefa (Camada A, um Markdown por tarefa):** [`tasks/README.md`](tasks/README.md) — **M0** em [`tasks/m0-baseline/`](tasks/m0-baseline/README.md); **M1** em [`tasks/m1-channel-t1-t2/`](tasks/m1-channel-t1-t2/README.md); **M2** em [`tasks/m2-channel-t3-ci/`](tasks/m2-channel-t3-ci/README.md); **M3** em [`tasks/m3-channel-t4-t6/`](tasks/m3-channel-t4-t6/README.md); **M4** em [`tasks/m4-channel-t5-agents/`](tasks/m4-channel-t5-agents/README.md); **M5** em [`tasks/m5-release-candidate/`](tasks/m5-release-candidate/README.md).
