...
│   │       ├── m1-remediation-r1/    # coverage-manifest.json; micro/ (M1-A1, M1-A2); A1-architect-…; A1-business-analyst-ruletester-r1-acceptance.md; A1-business-reviewer-ruletester-r1-signoff.md; A3-contract-sync…
