...
- [`agents-ref/`](agents-ref/) — **portfólio de referência** de instruções para agentes (governança, engenharia, compliance). Neste repositório, aplicar apenas conforme [`specs/agent-reference-agents.md`](../specs/agent-reference-agents.md) (não substitui `AGENTS.md` nem a política de documentação local).
