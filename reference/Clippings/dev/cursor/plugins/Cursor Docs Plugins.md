...
published:
created: 2026-04-12
description: "Browse, install, and manage plugins from the Cursor Marketplace."
tags:
  - "clippings"
---
Customizing
...
Plugins package rules, skills, agents, commands, MCP servers, and hooks into distributable bundles. Browse official plugins in the [Cursor Marketplace](https://cursor.com/marketplace). For community plugins and MCP servers, browse [cursor.directory](https://cursor.directory/). You can also [build your own](#creating-plugins) to share with other developers.
...
](https://cursor.com/docs/extension-api#plugin-paths)  
