---
title: "npm Docs"
source: "https://docs.npmjs.com/cli/v9/configuring-npm/package-json#keywords"
author:
published:
created: 2026-04-11
...
A name can be optionally prefixed by a scope, e.g. `@myorg/mypackage`. See [`scope`](https://docs.npmjs.com/cli/v9/using-npm/scope) for more detail.
...
See [folders](https://docs.npmjs.com/cli/v9/configuring-npm/folders#executables) for more info on executables.
...
See [`scripts`](https://docs.npmjs.com/cli/v9/using-npm/scripts) to find out more about writing package scripts.
...
These things will be installed when doing `npm link` or `npm install` from the root of a package, and can be managed like any other npm configuration param. See [`config`](https://docs.npmjs.com/cli/v9/using-npm/config) for more on the topic.
...
Unless the user has set the [`engine-strict` config](https://docs.npmjs.com/cli/v9/using-npm/config#engine-strict) flag, this field is advisory only and will only produce warnings when your package is installed as a dependency.
...
See [`config`](https://docs.npmjs.com/cli/v9/using-npm/config) to see the list of config options that can be overridden.
