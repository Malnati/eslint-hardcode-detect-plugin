---
title: "Debug Your Configuration - ESLint - Pluggable JavaScript Linter"
source: "https://eslint.org/docs/latest/use/configure/debug"
author:
published:
created: 2026-04-11
...
**What To Do:** Run ESLint with the [`--debug`](https://eslint.org/docs/latest/use/command-line-interface#--debug) command line flag and pass the file to check, like this:
...
**What To Do:** Run ESLint with the [`--print-config`](https://eslint.org/docs/latest/use/command-line-interface#--print-config) command line flag and pass the file to check, like this:
...
**What To Do:** Run ESLint with the [`--inspect-config`](https://eslint.org/docs/latest/use/command-line-interface#--inspect-config) command line flag and pass the file to check, like this:
...
![Config inspector screenshot showing which config objects match index.js](https://eslint.org/docs/latest/assets/images/configure/config-inspector.png)
