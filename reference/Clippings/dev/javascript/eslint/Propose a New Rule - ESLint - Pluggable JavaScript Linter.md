...
If you want to propose a new rule, please see how to [create a pull request](https://eslint.org/docs/latest/contribute/pull-requests) or submit an issue by filling out a [new rule template](https://github.com/eslint/eslint/issues/new/choose).
