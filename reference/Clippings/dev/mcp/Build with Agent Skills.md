...
## [Connect to a client](https://modelcontextprotocol.io/docs/develop/connect-local-servers)

Wire your server into an MCP client via local or remote configuration

## [Publish to the Registry](https://modelcontextprotocol.io/registry/quickstart)
