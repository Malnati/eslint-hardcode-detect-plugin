...
0. Confirme escopo e fontes com [`specs/agent-session-workflow.md`](../../../specs/agent-session-workflow.md) (Fases A–B); para ESLint, a consulta a Clippings é obrigatória antes de implementar. Se o pedido invocar ideias de [`reference/agents-ref/`](../../../reference/agents-ref/) (ex.: agente hardcoded genérico), cruze com [`specs/agent-reference-agents.md`](../../../specs/agent-reference-agents.md) e a skill [`reference-agents-portfolio`](../reference-agents-portfolio/SKILL.md). Se o trabalho envolver **publicação, registry privado ou MCP** (além do lint local), siga [`specs/agent-integration-testing-policy.md`](../../../specs/agent-integration-testing-policy.md) — sandboxes dos provedores; sem mocks de serviço no repositório.
