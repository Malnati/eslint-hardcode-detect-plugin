...
6. Se a documentação descrever **runbooks**, falhas de CI ou procedimentos de recuperação, alinhar exemplos de comunicação de erro a [`specs/agent-error-messaging-triple.md`](../../../specs/agent-error-messaging-triple.md) quando fizer sentido (prefixos `[HCD-ERR-SENIOR]`, `[HCD-ERR-FIX]`, `[HCD-ERR-OPS]`; três audiências e Níveis 1–3).
7. Incluir alterações de doc no mesmo fluxo de commit que [`specs/agent-git-workflow.md`](../../../specs/agent-git-workflow.md).
