...
5. Se o trabalho tiver seguido [`specs/agent-remediation-micro-roles.md`](specs/agent-remediation-micro-roles.md), confirme na mensagem final **que papéis** foram exercidos (ou que o pedido foi trivial e fora do âmbito).
