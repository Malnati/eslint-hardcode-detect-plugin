...
0. Se a entrega incluir **falhas** (testes, build, CI, comandos) a reportar, estruture-as conforme [`specs/agent-error-messaging-triple.md`](../../specs/agent-error-messaging-triple.md) (três partes: diagnóstico técnico sênior, correção definitiva, contorno operacional).
