...
| `.cursor/hooks.json` + `.cursor/hooks/` | Hooks Cursor de projeto: auditoria mecânica dos prefixos HCD-ERR (Níveis 1–2) em ficheiros alterados pelo Agent; registo em `.log/hooks/` (gitignored). Ver [`specs/agent-error-messaging-triple.md`](specs/agent-error-messaging-triple.md). |
